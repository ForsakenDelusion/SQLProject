...
CREATE TABLE `Device` (
  ...
  `Dstatus` enum('空闲中','使用中','维修中') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '空闲中',
  `Dprice` decimal(10,2) NOT NULL,
  `Ddate` date DEFAULT NULL,
  PRIMARY KEY (`Did`),
  KEY `Dname` (`Dname`)
) ENGINE=InnoDB AUTO_INCREMENT=20240529151137 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `Fixer` (
  ...
  KEY `Fname` (`Fname`),
  KEY `Ftele` (`Ftele`)
) ENGINE=InnoDB AUTO_INCREMENT=2023 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `User` (
  ...
  PRIMARY KEY (`Uid`)
) ENGINE=InnoDB AUTO_INCREMENT=2334 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
